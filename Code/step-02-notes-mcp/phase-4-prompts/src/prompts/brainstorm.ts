...
export async function getBrainstormPrompt(
  ...
  // Search for relevant existing notes
...
1. **Building on Existing Ideas**: Expand on related notes and find connections
...
Feel free to ask clarifying questions if you need more context.`;
